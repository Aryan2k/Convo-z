    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.imageView7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i= new Intent(StatusPage.this,StatusPrivacy.class);
                startActivity(i);
            }
        });
        ...
        binding.share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (photoPicked) {
                    ...
                    final StorageReference reference = storage.getReference().child("status_updates").child(FirebaseAuth.getInstance().getUid());

                    String time = String.valueOf(new Date().getTime());

                    reference.child(time).putFile(sFile).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        @Override
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {

                            reference.child(time).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                @Override
