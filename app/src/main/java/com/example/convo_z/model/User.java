...
public class User implements Serializable {
    ...
    public User(String profilePic, String userName, String email, String password, String userId, String lastSeen, String phoneNumber, String bio, ArrayList<HashMap<String, Object>> status, ArrayList<String> muted, ArrayList<String> blocked, ArrayList<String> hidden) {
