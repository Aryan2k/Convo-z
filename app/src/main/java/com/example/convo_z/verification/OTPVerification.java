...
public class OTPVerification extends AppCompatActivity {
    ...
    private void signInWithPhoneAuthCredential(PhoneAuthCredential credential) {
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(OTPVerification.this, task -> {
                        ...
                        database.getReference().child("Users").addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                if (!snapshot.hasChild(id)) //if not,add it to db.
                                {
                                    ...
                                    Intent i = new Intent(OTPVerification.this, ProfileSettingsActivity.class);
        ...
        Objects.requireNonNull(mAuth.getCurrentUser()).linkWithCredential(credential)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(OTPVerification.this, Objects.requireNonNull(task.getException()).toString(),
