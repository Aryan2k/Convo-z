...
public class OTPVerificationPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextCode = binding2.editTextOtp;

        progressDialog = new ProgressDialog(OTPVerificationPage.this);
        ...
        binding2.verifyOtp.setOnClickListener(v -> {
                        ...
                        database.getReference().child("Users").addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                if (!snapshot.hasChild(id)) //if not,add it to db.
                                {
                                    ...
                                    Intent i = new Intent(OTPVerificationPage.this, ProfileSettingsActivity.class);
                                    ...
                                    progressDialog.dismiss();
                                    Intent intent = new Intent(OTPVerificationPage.this, HomeActivity.class);
        ...
        Objects.requireNonNull(mAuth.getCurrentUser()).linkWithCredential(credential)
                .addOnCompleteListener(this, task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(OTPVerificationPage.this, Objects.requireNonNull(task.getException()).toString(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
